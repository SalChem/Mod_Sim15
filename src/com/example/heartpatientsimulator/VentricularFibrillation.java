...
public class VentricularFibrillation extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(VentricularFibrillation.this, Bluetooth.class));
			}
		});
	
		inputPath = "Ventricular Fibrillation Lead i.txt";
		InputStream input;
