...
public class Hypertrophy extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(Hypertrophy.this, Bluetooth.class));
			}
		});
	
		inputPath = "Hypertrophy Lead i.txt";
		InputStream input;
	 ...
	 graphView = new LineGraphView(
		...
		graphView.setManualYAxisBounds(1.33, -.283);
