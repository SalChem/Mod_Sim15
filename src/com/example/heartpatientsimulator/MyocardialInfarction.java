...
public class MyocardialInfarction extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(MyocardialInfarction.this, Bluetooth.class));
			}
		});
	
		inputPath = "Myocardial Infarction Lead i.txt";
		InputStream input;
	 ...
	 graphView = new LineGraphView(
		...
		graphView.setManualYAxisBounds(.399, -.643);
