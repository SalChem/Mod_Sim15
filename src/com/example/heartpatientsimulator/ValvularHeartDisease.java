...
public class ValvularHeartDisease extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(ValvularHeartDisease.this, Bluetooth.class));
			}
		});
	
		inputPath = "Valvular Heart Disease Lead i.txt";
		InputStream input;
    ...
    leadi.getStyle().color = Color.GREEN;
	 ...
	 graphView = new LineGraphView(
		...
		graphView.setViewPort(0, 2600);
	    graphView.setManualYAxisBounds(.68, -.5);
	...
	protected void onResume() {
		...
		mTimer1 = new Runnable() {
			...
			public void run() {
				...
				mHandler.postDelayed(this, 130);//speed (lower the faster)
			}
	};
