...
public class AtrialFibrillation extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(AtrialFibrillation.this, Bluetooth.class));
			}
		});
	
		inputPath = "Atrial Fibrillation Lead i.txt";
		InputStream input;
    ...
    leadi.getStyle().color = Color.GREEN;
	 ...
	 graphView = new LineGraphView(
	    ...
	    //graphView.setManualYAxisBounds(4.72, 3.52);
