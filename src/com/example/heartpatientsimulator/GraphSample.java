...
public class GraphSample extends View {
    ...
    public GraphSample(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        pointerPaint.setColor(Color.parseColor("#CC22FF"));
        pointerPaint.setStrokeWidth(10);
        pointerPaint.setAlpha(100);

        signalPaint = new Paint();
        signalPaint.setColor(Color.parseColor("#00CCFF"));
