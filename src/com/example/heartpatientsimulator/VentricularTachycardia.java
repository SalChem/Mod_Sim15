...
public class VentricularTachycardia extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(VentricularTachycardia.this, Bluetooth.class));
			}
		});
	
		inputPath = "Ventricular Tachycardia Lead i.txt";
		InputStream input;
    ...
    leadi.getStyle().color = Color.GREEN;
	 ...
	 graphView = new LineGraphView(
		...
		graphView.setViewPort(0, 450);
	   // graphView.setManualYAxisBounds(.356, -.18);
