...
public class UnstableAngina extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(UnstableAngina.this, Bluetooth.class));
			}
		});
	
		inputPath = "Unstable Angina Lead i.txt";
		InputStream input;
    ...
    leadi.getStyle().color = Color.GREEN;
	 ...
	 graphView = new LineGraphView(
	    ...
	    graphView.setManualYAxisBounds(.593, -.5);
