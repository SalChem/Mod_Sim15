...
public class BundleBranchBlock extends Activity {
	...
	private void Connect(){
		...
		messageButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(BundleBranchBlock.this, Bluetooth.class));
			}
		});
	
		inputPath = "Bundle Branch Block Lead i.txt";
		InputStream input;
    ...
    leadi.getStyle().color = Color.GREEN;
	 ...
	 graphView = new LineGraphView(
		...
		graphView.setViewPort(0, 2200);
	    graphView.setManualYAxisBounds(.99, -.235);
	...
	protected void onResume() {
		...
		public void run() {
			...
			mHandler.postDelayed(this, 99999);
		}
	};
	mHandler.postDelayed(mTimer3, 999999);
	}
 }
